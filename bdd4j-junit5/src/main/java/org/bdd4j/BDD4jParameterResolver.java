...
public class BDD4jParameterResolver implements ParameterResolver {
  private static Object getInstanceOfScenarioBuildersParameterizedType(Constructor<?> ctor,
  ...
  private static Object instantiateScenarioBuilder(Parameter scenarioBuilderParameter,
                                                   Class<?> type)
