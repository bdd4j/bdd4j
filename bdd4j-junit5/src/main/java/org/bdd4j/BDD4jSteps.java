 ...
 *
 * <p>Implementations should define factory methods for the {@link Given}, {@link When} and
 * {@link Then} steps for the scenarios, by using the builders defined in the {@link StepDSL} class
 * and exposing them to tests.
 *
 * <p>To initialize the test state the interface provides the {@link BDD4jSteps#init()} method,
 * which must be implemented by concrete step classes.
 *
 * <p>Instances of the steps can be injected into the scenario test methods. This is done by the
